...
orbits(Pattern, Orbits) :-
	...
	setOrbit(Pattern, Orbits, 0, 0, 0).
	

setOrbit(Pattern, Orbits, FirstPos, OrbitNo, FirstPos) :-
	(
		(
			ground(Orbits)
		);
		(
			...
			setOrbit(Pattern, Orbits, NextPos, NextOrbitNo, NextPos)
		)
	), !.
setOrbit(Pattern, Orbits, Pos, OrbitNo, FirstPos) :-
