:- module(siteswap_helpers,
	[
		...
		allHeightsSmaller/2,
		allHeightsHeigher/2,
		allHeightsHeigherOr0/2,
		listOfHeights/2,
		compare_heights/3,
		is_biggest/2,
		is_bigger_than_list/2,
		is_smallest/2,
		is_smaller_than_list/2,
		cleanEquals/2,
		containsEqual/2,
		areEqual/2,
		isTheSame/2,
		rotateAll/2,
		rotateHighestFirst/2,
		compare_swaps/3,
		cleanListOfSiteswaps/2,
		sortListOfSiteswaps/2,
		rat2float/2,
		mergeN/2,
		objects/2,
		objects/3,
